...
export function Dashboard(){
    return <div className="px-10">
        <div className="flex justify-between pt-10 pb-3" >
            <div className="font-bold text-4xl pb-3 tex-black">Fin Wallet</div>
            <div className="flex justify-between">
                <div className="text-md font-semibold">Hello User</div>
                {/* <img src="../assets/r" alt="" /> */}
            </div>
        </div>
        <hr />
        <div className="flex pt-5">
            <div className="font-bold pt-5 text-2xl">Your Balance   </div>
